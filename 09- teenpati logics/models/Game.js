...
export class Game {
  ...
  //   Add all players from array list
  ...
  placeBet(player, amount) {
    if (this.players[this.currentPlayerIndex].id === player.id) {
      if (player.hasFolded) {
        console.log("Card has already been folded. You cant bet");
        return;
      }
      if (player.balance < amount) {
        console.log("Betting amount exceeds total amount");
        return;
      } else if (amount < this.minimumBetAmount) {
        console.log(`Minimum Betting Amount is : ${this.minimumBetAmount} `);
        return;
      } else {
        ...
        console.log(
          `${player.name} bets ${amount}. Remaning ${player.name} amount ${player.balance}`
        );
      ...
      console.log("Please wait for you turn to bet");
    }
  }
  //   Pack cards
  foldPlayer(player) {
  ...
  showCards(player) {
    if (this.players[this.currentPlayerIndex].id === player.id) {
      ...
      console.log("Please wait for you turn to show");
    }
  }
